...
Configure your credentials the same way as [Azure Blob Storage](https://github.com/Gaukas/goofys100m/blob/master/README-azure.md#azure-blob-storage) above, and then:
