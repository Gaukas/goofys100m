...
[![Build Status](https://travis-ci.org/Gaukas/goofys100m.svg?branch=master)](https://travis-ci.org/Gaukas/goofys100m)
[![Github All Releases](https://img.shields.io/github/downloads/Gaukas/goofys100m/total.svg)](https://github.com/Gaukas/goofys100m/releases/)
...
* On Linux, install via [pre-built binaries](https://github.com/Gaukas/goofys100m/releases/latest/download/goofys). You may also need to install fuse-utils first.
...
$ go get github.com/Gaukas/goofys100m
$ go install github.com/Gaukas/goofys100m
```
...
See also: [Instruction for Azure Blob Storage, Azure Data Lake Gen1, and Azure Data Lake Gen2](https://github.com/Gaukas/goofys100m/blob/master/README-azure.md).

Got more questions? Check out [questions other people asked](https://github.com/Gaukas/goofys100m/issues?utf8=%E2%9C%93&q=is%3Aissue%20label%3Aquestion%20)
...
[bench.sh](https://github.com/Gaukas/goofys100m/blob/master/bench/bench.sh). [Raw data](https://github.com/Gaukas/goofys100m/blob/master/bench/)
...
```ShellSession
$ sudo docker run -e BUCKET=$TESTBUCKET -e CACHE=false --rm --privileged --net=host -v /tmp/cache:/tmp/cache Gaukas/goofys100m-bench
# result will be written to $TESTBUCKET
```

See also: [cached benchmark result](https://github.com/Gaukas/goofys100m/blob/master/bench/cache/README.md) and [result on Azure](https://github.com/Gaukas/goofys100m/blob/master/bench/azure/README.md).
